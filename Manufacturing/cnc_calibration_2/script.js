...
function calc_2() {
    ...
    document.getElementById("xoffset").innerHTML = "G0 " + "X" + Math.floor((res[0].x + res[1].x + res[2].x + res[3].x) / 4) / 1000 + " Y" + Math.floor((res[0].y + res[1].y + res[2].y + res[3].y) / 4) / (-1000);
    document.getElementById("yoffset").innerHTML = "Copied To Clipboard"
    setTimeout(() => { document.getElementById("yoffset").innerHTML = "                  " }, 1000);
    document.getElementById("rotation").innerHTML = "Rotation: " + Math.floor(1000 * (angleArray[0] + angleArray[1] + angleArray[2] + angleArray[3]) / 4) / 1000 + "°";


    navigator.clipboard.writeText(document.getElementById("xoffset").innerHTML);
